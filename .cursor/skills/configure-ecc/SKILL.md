---
name: configure-ecc
description: Interactive installer for Kodelyth ECC — guides users through selecting and installing skills and rules to user-level or project-level directories, verifies paths, and optionally optimizes installed files.
origin: ECC
---
