...
function detectTargetMode(rootDir) {
  ...
  if (packageJson?.name === 'kodelyth-ecc') {
    return 'repo';
  }
  ...
  return [
    {
      ...
      points: 4,
      scopes: ['repo'],
      path: '~/.claude/plugins/ecc/ (legacy kodelyth-ecc paths also supported)',
      description: 'Kodelyth ECC is installed for the active user or project',
