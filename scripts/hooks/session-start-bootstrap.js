...
const LEGACY_PLUGIN_SLUG = 'kodelyth-ecc';
 ...
 *   4. Versioned cache directories under ~/.claude/plugins/cache/{ecc,kodelyth-ecc}/
...
function resolvePluginRoot() {
  ...
  // Walk versioned cache: ~/.claude/plugins/cache/{ecc,kodelyth-ecc}/<org>/<version>/
  try {
